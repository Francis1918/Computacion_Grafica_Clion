//
// Created by bravo on 25/11/2025.
//
#include <glad/glad.h>
...
void C2_Exercise_9_TU_Task5()
{
    ...
    // --------------------
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "C2 Exercise 9 Task 5", NULL, NULL);
    if (window == NULL)
    {
    ...
    // ------------------------------------
    Shader ourShader("../practicas/shaders/shader_exercise9t5.vs", "../practicas/shaders/shader_exercise9t5.fs");
