...
void B2T4()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
                    ...
                    float spinSpeed, float spinTilt)
        {
            ...
            model = glm::rotate(model, spinTilt, glm::vec3(1.0f, 0.0f, 0.0f));
            model = glm::rotate(model, spinSpeed * t, glm::vec3(0.0f, 1.0f, 0.0f));
